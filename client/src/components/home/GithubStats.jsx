        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="glass p-6 rounded-[3rem] border border-slate-200 dark:border-slate-800 overflow-hidden flex justify-center bg-white/5">
              <img 
                src={`https://github-readme-stats.vercel.app/api?username=${username}&show_icons=true&theme=transparent&hide_border=true&title_color=0ea5e9&icon_color=0ea5e9&text_color=94a3b8&rank_icon=github&include_all_commits=true&count_private=true`} 
                alt="GitHub Stats" 
                className="w-full"
              />
            </div>
